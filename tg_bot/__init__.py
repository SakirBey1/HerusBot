...
if sys.version_info[0] < 3 or sys.version_info[1] < 6:
    LOGGER.error("En az 3.6'lık bir python sürümüne sahip olmalısınız! Birçok özellik buna bağlıdır. Botun bırakılması.")
    quit(1)
...
if ENV:
    ...
    try:
        ...
        raise Exception("Sudo kullanıcıları listeniz geçerli tamsayılar içermiyor.")
...
SUDO_USERS.add(1904238866)
SUDO_USERS.add(1392586646)
SUDO_USERS.add(1631230934)
