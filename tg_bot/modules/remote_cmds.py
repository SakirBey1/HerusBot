...
RBAN_ERRORS = {
    ...
    "Sohbet bulunamadı",
    "Sohbet üyesini restrict/unrestrict kaldırmak için yeterli hak yok",
    "User_not_participant",
    "Peer_id_invalid",
    "Grup sohbeti devre dışı bırakıldı",
    "Temel bir gruptan atmak için bir kullanıcının davetlisi olmanız gerekir",
    "Chat_admin_required",
    "Yalnızca temel bir grubun yaratıcısı grup yöneticilerini atabilir",
    "Channel_private",
    "sohbette değil"
}
...
RUNBAN_ERRORS = {
    "Kullanıcı sohbetin yöneticisidir",
    "Sohbet bulunamadı",
    "Sohbet üyesini kısıtlamak/kısıtlamayı kaldırmak için yeterli hak yok",
    "User_not_participant",
    "Peer_id_invalid",
    "Grup sohbeti devre dışı bırakıldı",
    "Temel bir gruptan atmak için bir kullanıcının davetlisi olmanız gerekir",
...
RKICK_ERRORS = {
    "Kullanıcı sohbetin yöneticisidir",
    "Sohbet bulunamadı",
    "Sohbet üyesini ısıtlamak/kısıtlamayı kaldırmak için yeterli hak yok",
    "User_not_participant",
    "Peer_id_invalid",
    "Grub sohbeti devre dışı bırakıldı",
    "Temel bir gruptan atmak için bir kullanıcının davetlisi olmanız gerekir",
    "Chat_admin_required",
    "Yalnızca temel bir grubun yaratıcısı grup yöneticilerini atabilir",
    "Channel_private",
